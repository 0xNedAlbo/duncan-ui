...
export const QUOTE_TOKEN_EXAMPLES = [
  ...
  },
  {
    ...
    token1: { symbol: 'LINK', address: '0x514910771AF9Ca656af840dff83E8264EcF986CA' },
    chain: 'ethereum',
  ...
  {
    token0: { symbol: 'LINK', address: '0x514910771AF9Ca656af840dff83E8264EcF986CA' },
    token1: { symbol: 'WETH', address: '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2' },
    chain: 'ethereum',
    expected: { token0IsQuote: false, quote: 'WETH', base: 'LINK' }
  },
  {
    token0: { symbol: 'WETH', address: '0x82aF49447D8a07e3bd95BD0d56f35241523fBAb1' },
    token1: { symbol: 'ARB', address: '0x912CE59144191C1204E64559FE8253a0e49E6548' },
    chain: 'arbitrum',
  ...
  {
    token0: { symbol: 'UNI', address: '0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984' },
    token1: { symbol: 'LINK', address: '0x514910771AF9Ca656af840dff83E8264EcF986CA' },
    chain: 'ethereum',
