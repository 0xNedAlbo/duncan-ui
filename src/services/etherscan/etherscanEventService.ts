...
// Chain configurations for NFT Position Manager addresses
        ...
        for (const eventType of eventTypes) {
            try {
                ...
                for (const log of logs) {
                    try {
                        const parsed = this.parseEventLog(
                            log,
                            eventType,
                            chain
                        );
    ...
    private parseEventLog(
        ...
        try {
            ...
            const baseEvent: Omit<
                RawPositionEvent,
                "liquidity" | "amount0" | "amount1" | "recipient"
            > = {
            ...
            switch (eventType) {
                case "INCREASE_LIQUIDITY": {
                    ...
                    const { liquidity, amount0, amount1 } =
                        this.decodeIncreaseLiquidityData(log.data);
                    return {
                        ...baseEvent,
                ...
                case "DECREASE_LIQUIDITY": {
                    ...
                    const { liquidity, amount0, amount1 } =
                        this.decodeDecreaseLiquidityData(log.data);
                    return {
                        ...baseEvent,
                        liquidity: liquidity.toString(),
                        amount0: amount0.toString(),
                ...
                case "COLLECT": {
                    ...
                    const { recipient, amount0, amount1 } =
                        this.decodeCollectData(log.data);
                    return {
                        ...baseEvent,
                        amount0: amount0.toString(),
                        amount1: amount1.toString(),
