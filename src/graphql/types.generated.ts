...
export type GetPositionQuery = { __typename?: 'Query', position?: { __typename?: 'Position', id: string, liquidity: string, depositedToken0: string, depositedToken1: string, withdrawnToken0: string, withdrawnToken1: string, collectedFeesToken0: string, collectedFeesToken1: string, transaction: { __typename?: 'Transaction', id: string, timestamp: string, blockNumber: string, gasUsed: string, gasPrice: string }, pool: { __typename?: 'Pool', id: string, feeTier: string, token0Price: string, token1Price: string, liquidity: string, sqrtPrice: string, tick?: string | null, token0: { __typename?: 'Token', id: string, symbol: string, name: string, decimals: string }, token1: { __typename?: 'Token', id: string, symbol: string, name: string, decimals: string } } } | null };
...
export type GetPositionsByOwnerQuery = { __typename?: 'Query', positions: Array<{ __typename?: 'Position', id: string, liquidity: string, depositedToken0: string, depositedToken1: string, withdrawnToken0: string, withdrawnToken1: string, collectedFeesToken0: string, collectedFeesToken1: string, transaction: { __typename?: 'Transaction', id: string, timestamp: string, blockNumber: string }, pool: { __typename?: 'Pool', id: string, feeTier: string, token0Price: string, token1Price: string, token0: { __typename?: 'Token', id: string, symbol: string, name: string, decimals: string }, token1: { __typename?: 'Token', id: string, symbol: string, name: string, decimals: string } } }> };
...
export type GetPoolQuery = { __typename?: 'Query', pool?: { __typename?: 'Pool', id: string, createdAtTimestamp: string, createdAtBlockNumber: string, feeTier: string, token0Price: string, token1Price: string, liquidity: string, sqrtPrice: string, tick?: string | null, volumeToken0: string, volumeToken1: string, volumeUSD: string, totalValueLockedToken0: string, totalValueLockedToken1: string, totalValueLockedUSD: string, feesUSD: string, txCount: string, token0: { __typename?: 'Token', id: string, symbol: string, name: string, decimals: string, totalSupply: string, volume: string, volumeUSD: string, derivedETH: string, totalValueLocked: string, totalValueLockedUSD: string }, token1: { __typename?: 'Token', id: string, symbol: string, name: string, decimals: string, totalSupply: string, volume: string, volumeUSD: string, derivedETH: string, totalValueLocked: string, totalValueLockedUSD: string } } | null };
...
export type GetFactoryQuery = { __typename?: 'Query', factory?: { __typename?: 'Factory', id: string, poolCount: string, txCount: string, totalVolumeUSD: string, totalVolumeETH: string, totalFeesUSD: string, totalFeesETH: string, totalValueLockedUSD: string, totalValueLockedETH: string, owner: string } | null };
...
export type GetTokenQuery = { __typename?: 'Query', token?: { __typename?: 'Token', id: string, symbol: string, name: string, decimals: string, totalSupply: string, volume: string, volumeUSD: string, feesUSD: string, txCount: string, poolCount: string, totalValueLocked: string, totalValueLockedUSD: string, derivedETH: string } | null };
...
export type GetPoolDayDataQuery = { __typename?: 'Query', poolDayDatas: Array<{ __typename?: 'PoolDayData', id: string, date: number, liquidity: string, sqrtPrice: string, token0Price: string, token1Price: string, tick?: string | null, tvlUSD: string, volumeToken0: string, volumeToken1: string, volumeUSD: string, feesUSD: string, txCount: string, open: string, high: string, low: string, close: string }> };
